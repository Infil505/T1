<template>
  <div class="detail-container">
    ...
    <div v-if="editorial.libros && editorial.libros.length">
      <h3><i class="fas fa-book"></i> Libros publicados:</h3>
      <ul>
        <li v-for="libro in editorial.libros" :key="libro.id">
    ...
    <p v-else>No hay libros registrados para esta editorial.</p>

    <Link href="/publisher" class="back-link">← Volver a la lista</Link>
  </div>
</template>
